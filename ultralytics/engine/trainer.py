...
class BaseTrainer:
    ...
    def _do_train(self, world_size=1):
        ...
        # print(self.train_loader.dataset.labels)
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            # print(type(self.train_loader.dataset.labels))
            # print(nb)
    ...
    def validate(self):
        ...
        try:
            ...
            fitness = metrics.pop('fitness',-self.loss_one_frame.detach().cpu().numpy())  # use loss as fitness measure if not found
